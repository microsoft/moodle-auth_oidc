...
/**
 * Userdata class for oidc tokens.
 */
class token extends \totara_userdata\userdata\item {
    ...
    public static function get_fullname_string() {
        return ['userdataitem-token', 'auth_oidc'];
    }
    ...
    protected static function export(target_user $user, \context $context) {
        global $DB;
        $export = new export();
        $records = $DB->get_records('auth_oidc_token', ['username' => $user->username]);
        $export->data = $records;
        return $export;
    }
    ...
    protected static function count(target_user $user, \context $context) {
        global $DB;
        return $DB->count_records('auth_oidc_token', ['username' => $user->username]);
    }
